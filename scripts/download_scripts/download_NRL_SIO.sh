...
wget --no-check-certificate --user=nrltransfer --password=NESM2017! -nH --cut-dirs=20 -r -A "ARC*_182_*.gz" -N $data_ftp
wget --no-check-certificate --user=nrltransfer --password=NESM2017! -nH --cut-dirs=20 -r -A "ANT*_182_*.gz" -N $data_ftp
