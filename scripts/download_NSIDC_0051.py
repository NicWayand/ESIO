...
def BatchJob(Files, cookie_jar, year, url):
...
def main(year):
    ...
    os.chdir('/home/disk/sipn/nicway/data/obs/NSIDC_0051')

    # The FULL url of the directory which contains the files you would like to bulk download
    url = "https://daacdata.apps.nsidc.org/pub/DATASETS/nsidc0051_gsfc_nasateam_seaice/final-gsfc/north/daily/"+str(year)+'/' # Example URL
